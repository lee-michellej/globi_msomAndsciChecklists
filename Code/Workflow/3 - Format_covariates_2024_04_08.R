...
citation.type <- c("Aggregated Data", # [1] "A. Thessen. 2014. Species associations extracted from EOL text data objects via text mining."                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
                   ...
                   "Literature" # [50] "Web of Life. http://www.web-of-life.es ."
