...
# We will estimate 2 quantities:
  # The probability a bee species interacts with a plant species
  # The probability that a study documents a bee-plant interaction
...
psi <- runif(n.bee, min = 0, max = 1)

# Looking at the values
  # There is 1 value per bee species, and it represents the probability that a bee species interacts with a plant species
psi

# p = The probability that a study documents a bee-plant interaction
  # This probability can vary by bee and plant species later- but here we are assuming it is constant across bee and plant species
p <- 0.7
